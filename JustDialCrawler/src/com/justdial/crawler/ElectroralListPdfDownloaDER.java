...
public class ElectroralListPdfDownloaDER {

	public static void main(String[] args) {

		String numberArray[] = { "001", "002", "003", "004", "005", "006",
		...
		String text1 = "http://ceoaperms1.ap.gov.in/Electoral_Rolls/PDFGeneration.aspx?urlPath=F:\\RUNNING_APPLICATIONS_23012018\\FINALROLLS_SSR_2018\\AC_";
		String text2 = "";
		String text3 = "\\English\\S01A";
		String text4 = "";
		String text5 = "P";
		String text6 = "";
		String text7 = ".PDF";
		...
		for (int i = 22; i < 23; i++) {
			for (int j = 0; j < 271; j++) {
				...
				System.out.println(text1 + numberArray[i] + text3
						+ numberArray[i] + text5 + numberArray[j] + text7);
